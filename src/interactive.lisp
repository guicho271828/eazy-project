#|
This file is a part of eazy-project.interactive project.
Copyright (c) 2013 Masataro Asai (guicho2.71828@gmail.com)
|#

(in-package :cl-user)
(defpackage eazy-project.interactive
  (:use :cl :eazy-project :iterate :annot.doc)
  (:import-from :osicat
		:environment-variable
		:current-directory))
(in-package :eazy-project.interactive)
